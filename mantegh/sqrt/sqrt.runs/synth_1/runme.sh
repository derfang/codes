...
HD_PWD='C:/Users/PADIDAR/Desktop/temp/codes/mantegh/sqrt/sqrt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log YBlock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source YBlock.tcl
