...
HD_PWD='C:/Users/PADIDAR/Desktop/tamrin1_9923061/silmple6bitmultiplier/simplemulty/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multy.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multy.tcl -notrace
