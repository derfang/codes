...
HD_PWD='C:/Users/PADIDAR/Desktop/tamrin1_9923061/silmple6bitmultiplier/simplemulty/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multy.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multy.tcl
